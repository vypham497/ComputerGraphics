...
function init() 
{
    ...
    var Dodecahedron = GetPointDodecahedron(0.7, 0);
    ...
    DodecahedronFolder.add(Dodecahedron.scale, 'x', 0, 2);
    DodecahedronFolder.add(Dodecahedron.scale, 'y', 0, 2);
    DodecahedronFolder.add(Dodecahedron.scale, 'z', 0, 2);
...
function update(renderer, scene, camera, controls)
{
    ...
    var Dodecahedron = scene.getObjectByName('Dodecahedron');
...
function GetPointDodecahedron(radius, detail){
    var dodecahedronGeometry = new DodecahedronGeometry(radius, detail);
    var material = new THREE.PointsMaterial( { color: 'rgb(0,0,0)', size: 0.1} );
    var point = new THREE.Points(dodecahedronGeometry, material );
