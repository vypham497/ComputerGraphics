...
function init() 
{
    ...
    var Dodecahedron = GetLineDodecahedron(0.7, 0);
...
function GetLineDodecahedron(radius, detail){

    var dodecahedronGeometry = new THREE.DodecahedronGeometry(radius, detail);
    var wireframe = new THREE.WireframeGeometry(dodecahedronGeometry);
    var line = new THREE.LineSegments(wireframe);
    line.material.depthTest = false;
    line.material.opacity = 1;
    line.material.transparent = true;
    line.material.color = "rgb(0,0,0)";
