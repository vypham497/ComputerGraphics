...
function init() 
{
    ...
    var Dodecahedron = GetSolidDodecahedron(0.7, 0);
...
function GetSolidDodecahedron(radius, detail){
    var dodecahedronGeometry = new DodecahedronGeometry(radius, detail);
    var textureLoader = new THREE.TextureLoader();
    var image = textureLoader.load('./image/octahedron.jpg');
